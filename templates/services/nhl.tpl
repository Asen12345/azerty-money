<h2>Оформить заказ</h2>
						...
						<div class="clr"><span> </span></div>
<h2>Данные о трансфере:</h2>
<input class="gold_input_name" name="Имя игрока">
<p class="leave_a_comment-p calculator">Имя игрока</p>
<input class="gold_input_name" name="Рейтинг игрока">
<p class="leave_a_comment-p calculator">Рейтинг игрока</p>
<input class="gold_input_name" name="Ваша команды UT">
<p class="leave_a_comment-p calculator">Ваша команды UT</p>
<input class="gold_input_name" name="Время аукциона">
<p class="leave_a_comment-p calculator">Время аукциона</p>
<input class="gold_input_name" name="Начальная цена аукциона">
<p class="leave_a_comment-p calculator">Начальная цена аукциона</p>
<input class="gold_input_name" name="Цена выкупа">
<p class="leave_a_comment-p calculator">Цена выкупа</p>
<h2>Контактная информация</h2>
<input class="gold_input_name" name="Укажите VK или Skype:">
	<p class="leave_a_comment-p calculator">Укажите VK или Skype:</p>
