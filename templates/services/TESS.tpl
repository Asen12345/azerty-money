<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1000 ед. золота: <span></span></p></br>
						<div class="clr"><span> </span></div>
                        <input class="gold_input_name" name="ID учётной записи" required>
                        <p class="leave_a_comment-p calculator">ID учётной записи</p>
						<div class="clr"><span> </span></div>
