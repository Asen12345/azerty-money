<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1 млн серебра: <span></span></p></br>
						<div class="clr"><span> </span></div>
...
<script>
							$(document).ready(function(){
								$('input[id=radio1]').change(function(){
									...
									$('span[name=text1]').text('Вам необходимо иметь при себе кол-во серебра равное 1% от общей стоимости');
								});	  
							});
						</script>
