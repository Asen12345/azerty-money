...
<script>
							$(document).ready(function(){
								$('input[id=radio1]').change(function(){
									...
									$('span[name=text1]').text('10% комиссии мы берем на себя');
								});	  
							});
						</script>
                        ...
                        <p class="p-delivery_method">
                            ...
                            <label class="radio-delivery_method">
                                <input name="Способ доставки" type="radio" id="radio2" value="Через аукцион"><span></span>
                            </label>
                                <label for="radio2">Через аукцион</label><br>
