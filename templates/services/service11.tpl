<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1 ключ: <span></span></p></br>
						<div class="clr"><span> </span></div>
                        <input class="gold_input_name" name="Укажите ваш логин Steam">
                        <p class="leave_a_comment-p calculator">Укажите ваш логин Steam</p>
						<div class="clr"><span> </span></div>
