...
<script>
							$(document).ready(function(){
								...
								$('input[id=radio2]').change(function(){
									$('span[name=text1]').text('Следите за новыми письмами, Кинары будут вложены в конверт. Данный способ желательно выбирать если сумма до 150 000 000');
									$('span[name=text2]').text('');
								});	  
								$('input[id=radio3]').change(function(){
									$('span[name=text1]').text('');
									$('span[name=text2]').text('Ожидайте доставку в (Пандемониум/Эллизиум) возле главного кибелиска. Лучший способ передачи для суммы свыше 150 000 000');
								});	 
							});
						</script>
                        ...
                        <p class="p-delivery_method">
                            ...
                            <label class="radio-delivery_method">
                                <input name="Способ доставки" type="radio" id="radio3" value="Через частную лавку"><span></span>
                            </label>
                                <label for="radio3">Через частную лавку</label><br>
