...
<script>
							$(document).ready(function(){
								...
								$('input[id=radio2]').change(function(){
									$('span[name=text1]').text('Заказ может доставляться по частям в течение указанного срока доставки. Поэтому не переживайте, если первой почтой у вас придет меньше товара, чем указано в заказе');
								});	
							});
						</script>
