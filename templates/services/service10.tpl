<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1ккк исков: <span></span></p></br>
						<div class="clr"><span> </span></div>
...
<script>
							$(document).ready(function(){
								...
								$('input[id=radio2]').change(function(){
									$('span[name=text1]').text('Передача товара на станции или в космосе на вашу сумму. Ваш персонаж должен находиться в игре. В примечании можете писать в какое время вам будет удобней получить товар. Данный способ есть безопасным и лучшим вариантом для передачи. Вам передадут товара на сумму Plex в игре, а вы просто купите его');
								});	
							});
						</script>
