<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1кк АБ: <span></span></p></br>
						<div class="clr"><span> </span></div>
...
<script>
							$(document).ready(function(){
								$('input[id=radio1]').change(function(){
									...
									$('span[name=text1]').text('Выставьте на аукцион любой предмет с выкупом равным сумме заказа. Комиссия за нас счет.');
								});	  
							});
						</script>
                        ...
                        <p class="p-delivery_method">
                            ...
                            <label class="radio-delivery_method">
                                <input name="Способ доставки" type="radio" id="radio2" value="Аукцион"><span></span>
                            </label>
                                <label for="radio2">Аукцион</label><br>
