...
<script>
							$(document).ready(function(){
								...
								$('input[id=radio2]').change(function(){
									$('span[name=text1]').text('После оплаты, свяжитесь с оператором для уточнения времени и места передачи игровой валюты');
								});	
							});
						</script>
                        ...
                        <p class="p-delivery_method">   
                            <label class="radio-delivery_method">
                                <input name="Способ доставки" type="radio" id="radio2" value="Обмен в игре"><span></span>
                            </label>
                                <label for="radio2">Обмен в игре</label><br>
