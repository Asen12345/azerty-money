<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1000 серебра: <span></span></p></br>
						<div class="clr"><span> </span></div>
...
<script>
		$(document).ready(function(){
			...
			$('input[id=radio2]').change(function(){
				$('span[name=text1]').text('Для этого вам нужно будет подойти в город Seven Spires к банку-сундуку.');
				$('span[name=text2]').text('');
				$('span[name=text3]').text('');
			});
		});
