...
<script>
							$(document).ready(function(){
								$('input[id=radio1]').change(function(){
									...
									$('span[name=text1]').text('Заходите в инст, вместе с поставщиком, обычно это Гео. Выбивается лут и поставщик делает ставку в соответствии заказу. Вы соответственно отказываетесь и получаете голд.');
								});	  
							});
						</script>
                        ...
                        <p class="p-delivery_method">
                            ...
                            <label class="radio-delivery_method">
                                <input name="Способ доставки" type="radio" id="radio2" value="Через Ф8"><span></span>
                            </label>
                                <label for="radio2">Через Ф8</label><br>
