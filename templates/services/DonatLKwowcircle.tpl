<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1 бонус: <span></span></p></br>
						<div class="clr"><span> </span></div>
						...
						<div class="clr"><span> </span></div>
						<input class="gold_input_name" name="Укажите id вещи из ЛК" required>
                        <p class="leave_a_comment-p calculator">Укажите id вещи из ЛК</p>
						<div class="clr"><span> </span></div>
 ...
 <script>
							$(document).ready(function(){
								...
								$('input[id=radio3]').change(function(){
									$('span[name=text2]').text('Почта идет 1 час! ');
									$('span[name=text1]').text('');
								});		 
							});
						</script>
