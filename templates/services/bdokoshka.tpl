<h2>Оформить заказ</h2>
						...
						<p class="leave_a_comment-b" name="sum_game" style="display:none;">Цена за 1 кошку <span></span></p></br>
						<div class="clr"><span> </span></div>
                        ...
                        <input class="input-buy_paying" name="calc1">
...
<script>
                        ...
                        <p class="p-delivery_method">
                            <label class="radio-delivery_method">
                                <input name="Способ доставки" type="radio" id="radio1" checked value="В городе Велия"><span></span>
                            </label>
                            <label for="radio1">В городе Велия</label>
                            <label class="radio-delivery_method">
                        </p>
