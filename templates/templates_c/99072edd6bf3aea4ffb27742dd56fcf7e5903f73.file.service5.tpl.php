<?php /* Smarty version Smarty-3.1.18, created on 2020-05-28 11:15:37
         compiled from "templates/services/service5.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16482588315ecf7329c3c4e3-08334989%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99072edd6bf3aea4ffb27742dd56fcf7e5903f73' => 
    array (
      0 => 'templates/services/service5.tpl',
      1 => 1589614278,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16482588315ecf7329c3c4e3-08334989',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ecf7329cc5824_25523283',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ecf7329cc5824_25523283')) {function content_5ecf7329cc5824_25523283($_smarty_tpl) {?><h2>Оформить заказ</h2>
...
"><?php echo $_smarty_tpl->tpl_vars['item']->value['caption'];?>
                        ...
                        <select class="gold_game_selection" name="Укажите сторону">
                            <option value="Асмодиане">Асмодиане</option>
                            <option value="Элийцы">Элийцы</option>
                        </select>
...
<script>
							$(document).ready(function(){
								...
								$('input[id=radio2]').change(function(){
									$('span[name=text1]').text('Самый удобный способ для доставки Кинар!');
								});	
							});
						</script>
