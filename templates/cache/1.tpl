...
<div class="container">
  ...
  <div id="rov">
              ...
              <div class="data__row">
                ...
                <div class="data__side_cur">
                  <div class="side__div">
                    ...
                    <input type="number" id="valutee"  name="calc2" class="data__input data__input_cur" required="" aria-required="true">
              ...
              <div class="data__row">
                ...
                <input type="text" name="Укажите имя персонажа" class="data__input data__input_nicc data__input_nic" placeholder="Никнейм" required="" aria-required="true">
              </div>
              <div class="data__row">
              ...
              <div class="data__row">
                ...
                <textarea name="com" class="data__input data__input_nic  data__textarea" placeholder="Как с вами связаться? Укажите удобный вам способ связи (WhatsApp, Telegram, Skype, VK)" required="" aria-required="true"></textarea>
              </div>
              <div class="data__row_last">
                <div class="data__check">
                  ...
                  <div class="data__text">
                    Я ознакомился с <a href="https://azerty-money.ru/content/view/3" class="data__link">условиями соглашения</a>
                  </div>
                </div>
  ...
  #test_i img{
      display: none;
                  ...
                  {if $formsData.type==0}
                  <input type="hidden" value="" id="misu" name="misu" />
  ...
  var serv = $("#data__server");
  var serv1 = serv.val();
  
  var serv2 = $("#valutee");
  var serv3 = serv2.val();
  
  var serv4 = $(".data__input_nicc");
  var serv5 = serv4.val();
  ...
  var serv6 = $(".data__textarea");
  
  var serv7 = serv6.val();
  
        $(".total__btn").click(function(){
  ...
  console.log("true");
  $("#misu").val('1');
  console.log($("#misu").val());
  }
  else{
    $("#misu").val('0');
  console.log($("#misu").val());
    alert('Минимальная сумма ' + srav);
 }
 
  if(serv1 == ""){
    $("#data__server").css("border", "2px solid red");
  }
  
  else{
    $("#data__server").css("border", "0px solid red");
  }
  
  if(serv3 == ""){
    $("#valutee").css("border", "2px solid red");
  }
  else{
    $("#valutee").css("border", "0px solid red");
  }
  
  
  if(serv5 == ""){
    $(".data__input_nicc").css("border", "2px solid red");
  }
  else{
    $(".data__input_nicc").css("border", "0px solid red");
  }
  
  
  if(serv7 == ""){
    $(".data__textarea").css("border", "2px solid red");
  }
  else{
    $(".data__textarea").css("border", "0px solid red");
  }
     ...
     {if $item.answer}
           ...
           {if $smarty.session.lase > 1}

            <div class="catalog__pages review__pages">

           {if $smarty.get.feed > 2}
              <a
              style="text-decoration:none;" href=?feed=1>
           ...
           ...
              ...
              style="text-decoration:none;" href=?feed={$foo}>
                ...
                {if $smarty.get.feed < $smarty.session.lase - 2}
                ...
                <a
                style="text-decoration:none;" href=?feed={$smarty.session.lase}>
               
              
                    <p>{$smarty.session.lase}</p>
