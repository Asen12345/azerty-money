...
<div class="menu">
    ...
    <div class="menu__footer">
      <a href="/admin" class="menu__user">
        Аккаунт
      </a>
      <a href="/login" class="menu__user">
        Вход
      </a>
    </div>
  </div>
    ...
    <div class="header" id="header">
      <div class="container">
        <div class="header-nav">
          ...
          <a href="/login" class="header__admin">
        ...
        <!-- Тут заканчивается "Header" (повторяюшиеся элементы) -->
...
<div class="error__body">
      <img src="https://azerty-money.ru/images/404.png" alt="404" class="error__img">
